...
{
    public partial class mariposa : Form
    {
        ...
        private void mariposa_Load(object sender, EventArgs e)
        {
            for (int i = 0; i <= 200; i++)
            {
                angka.Add(i);
            ...
            // Mariposa
            PictureBox pb_mariposa = new PictureBox();
            pb_mariposa.Image = Image.FromFile("C:\\Users\\HP\\source\\repos\\THA_W7_Livanty\\THA_W7_Livanty\\mariposa.jpg");
            pb_mariposa.Location = new Point(20, 10);
            pb_mariposa.Size = new Size(200, 210);
            pb_mariposa.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(pb_mariposa);

            Label lbl_mariposa = new Label();
            lbl_mariposa.Text = "MARIPOSA";
            lbl_mariposa.Location = new Point(20, 230);
            lbl_mariposa.Size = new Size(150, 40);
            this.Controls.Add(lbl_mariposa);
        ...
        private void btnjam1_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitmariposa1 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    // MessageBox.Show("piu");
                    int random1 = random.Next(0, 170);
                    Form1.simpanmariposa1.Add(random1);
            ...
            for (int i = 0; i < Form1.simpanmariposa1.Count; i++)
            {
                foreach (Button a in seat1)
                {
                    if (Form1.simpanmariposa1[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanmariposa1.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam2_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitmariposa2 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanmariposa2.Add(random1);
                }
            }
            Form1.hitmariposa2 = 1;
            ...
            for (int i = 0; i < Form1.simpanmariposa2.Count; i++)
            {
                foreach (Button a in seat2)
                {
                    if (Form1.simpanmariposa2[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke2_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanmariposa2.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam3_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitmariposa3 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanmariposa3.Add(random1);
                }
            }
            Form1.hitmariposa3 = 1;
            ...
            for (int i = 0; i < Form1.simpanmariposa3.Count; i++)
            {
                foreach (Button a in seat3)
                {
                    if (Form1.simpanmariposa3[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke3_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanmariposa3.Add(Convert.ToInt32(i));
            }
