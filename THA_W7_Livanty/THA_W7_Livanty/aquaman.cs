...
{
    public partial class aquaman : Form
    {
        public aquaman()
        {
            InitializeComponent();
        ...
        private void aquaman_Load(object sender, EventArgs e)
        {
            ...
            // Aquaman
            PictureBox pb_aquaman = new PictureBox();
            pb_aquaman.Image = Image.FromFile("C:\\Users\\HP\\source\\repos\\THA_W7_Livanty\\THA_W7_Livanty\\aquaman.jpg");
            pb_aquaman.Location = new Point(20, 10);
            pb_aquaman.Size = new Size(200, 210);
            pb_aquaman.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(pb_aquaman);

            Label lbl_aquaman = new Label();
            lbl_aquaman.Text = "AQUAMAN";
            lbl_aquaman.Location = new Point(20, 230);
            lbl_aquaman.Size = new Size(150, 40);
            this.Controls.Add(lbl_aquaman);
        ...
        private void btnjam1_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitaquaman1 == 0)
            {
                for (int i = 0; i < 70; i++)
                {                    
                    int random1 = random.Next(0, 170);
                    Form1.simpanaquaman1.Add(random1);
            ...
            for (int i = 0; i < Form1.simpanaquaman1.Count; i++)
            {
                foreach (Button a in seat1)
                {
                    if (Form1.simpanaquaman1[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanaquaman1.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam2_Click(object sender, EventArgs e)
        {
            ...
            int hitung = 1;
            panel1.Controls.Clear();
            if (Form1.hitaquaman2 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanaquaman2.Add(random1);
                }
            }
            Form1.hitaquaman2 = 1;
            ...
            for (int i = 0; i < Form1.simpanaquaman2.Count; i++)
            {
                foreach (Button a in seat2)
                {
                    if (Form1.simpanaquaman2[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke2_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanaquaman2.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam3_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitaquaman3 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanaquaman3.Add(random1);
                }
            }
            Form1.hitaquaman3 = 1;
            ...
            for (int i = 0; i < Form1.simpanaquaman3.Count; i++)
            {
                foreach (Button a in seat3)
                {
                    if (Form1.simpanaquaman3[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke3_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanaquaman3.Add(Convert.ToInt32(i));
            }
