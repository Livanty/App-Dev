...
{
    public partial class jumanji : Form
    {
        public jumanji()
        {
            InitializeComponent();
        ...
        private void jumanji_Load(object sender, EventArgs e)
        {
            for (int i = 0; i <= 200; i++)
            {
                angka.Add(i);
            ...
            // Jumanji
            PictureBox pb_jumanji = new PictureBox();
            pb_jumanji.Image = Image.FromFile("C:\\Users\\HP\\source\\repos\\THA_W7_Livanty\\THA_W7_Livanty\\jumanji.jpg");
            pb_jumanji.Location = new Point(20, 10);
            pb_jumanji.Size = new Size(200, 210);
            pb_jumanji.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(pb_jumanji);

            Label lbl_jumanji = new Label();
            lbl_jumanji.Text = "JUMANJI";
            lbl_jumanji.Location = new Point(20, 230);
            lbl_jumanji.Size = new Size(150, 40);
            this.Controls.Add(lbl_jumanji);
        ...
        private void btnjam1_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitjumanji1 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    // MessageBox.Show("piu");
                    int random1 = random.Next(0, 170);
                    Form1.simpanjumanji1.Add(random1);
            ...
            for (int i = 0; i < Form1.simpanjumanji1.Count; i++)
            {
                foreach (Button a in seat1)
                {
                    if (Form1.simpanjumanji1[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanjumanji1.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam2_Click(object sender, EventArgs e)
        {
            ...
            panel1.Controls.Clear();
            if (Form1.hitjumanji2 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanjumanji2.Add(random1);
                }
            }
            Form1.hitjumanji2 = 1;
            ...
            for (int i = 0; i < Form1.simpanjumanji2.Count; i++)
            {
                foreach (Button a in seat2)
                {
                    if (Form1.simpanjumanji2[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke2_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanjumanji2.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam3_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitjumanji3 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanjumanji3.Add(random1);
                }
            }
            Form1.hitjumanji3 = 1;
            ...
            for (int i = 0; i < Form1.simpanjumanji3.Count; i++)
            {
                foreach (Button a in seat3)
                {
                    if (Form1.simpanjumanji3[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
            ...
            btnoke3.Location = new Point(2600, 315);
        ...
        private void btnoke3_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanjumanji3.Add(Convert.ToInt32(i));
            }
