...
{
    public partial class bighero : Form
    {
        public bighero()
        {
            InitializeComponent();
        ...
        private void bighero_Load(object sender, EventArgs e)
        {
            for (int i = 0; i <= 200; i++)
            {
                angka.Add(i);
            ...
            // Big Hero
            PictureBox pb_bighero = new PictureBox();
            pb_bighero.Image = Image.FromFile("C:\\Users\\HP\\source\\repos\\THA_W7_Livanty\\THA_W7_Livanty\\bighero.jpg");
            pb_bighero.Location = new Point(20, 10);
            pb_bighero.Size = new Size(200, 210);
            pb_bighero.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(pb_bighero);

            Label lbl_bighero = new Label();
            lbl_bighero.Text = "BIG HERO";
            lbl_bighero.Location = new Point(20, 230);
            lbl_bighero.Size = new Size(150, 40);
            this.Controls.Add(lbl_bighero);
        ...
        private void btnjam1_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitbighero1 == 0)
            {
                for (int i = 0; i < 70; i++)
                { 
                    int random1 = random.Next(0, 170);
                    Form1.simpanbighero1.Add(random1);
            ...
            for (int i = 0; i < Form1.simpanbighero1.Count; i++)
            {
                foreach (Button a in seat1)
                {
                    if (Form1.simpanbighero1[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanbighero1.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam2_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitbighero2 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanbighero2.Add(random1);
                }
            }
            Form1.hitbighero2 = 1;
            ...
            for (int i = 0; i < Form1.simpanbighero2.Count; i++)
            {
                foreach (Button a in seat2)
                {
                    if (Form1.simpanbighero2[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke2_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanbighero2.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam3_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitbighero3 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanbighero3.Add(random1);
                }
            }
            Form1.hitbighero3 = 1;
            ...
            for (int i = 0; i < Form1.simpanbighero3.Count; i++)
            {
                foreach (Button a in seat3)
                {
                    if (Form1.simpanbighero3[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke3_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanbighero3.Add(Convert.ToInt32(i));
            }
