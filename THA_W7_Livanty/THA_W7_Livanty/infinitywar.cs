...
namespace THA_W7_Livanty
{
    public partial class infinitywar : Form
    {
        ...
        private void infinitywar_Load(object sender, EventArgs e)
        {
            for (int i = 0; i <= 200; i++)
            {
                angka.Add(i);
            ...
            // Infinity War
            PictureBox pb_infinitywar = new PictureBox();
            pb_infinitywar.Image = Image.FromFile("C:\\Users\\HP\\source\\repos\\THA_W7_Livanty\\THA_W7_Livanty\\infinitywar.jpeg");
            pb_infinitywar.Location = new Point(20, 10);
            pb_infinitywar.Size = new Size(200, 210);
            pb_infinitywar.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(pb_infinitywar);

            Label lbl_infinitywar = new Label();
            lbl_infinitywar.Text = "INFINITY WAR";
            lbl_infinitywar.Location = new Point(20, 230);
            lbl_infinitywar.Size = new Size(150, 40);
            this.Controls.Add(lbl_infinitywar);
        ...
        private void btnjam1_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitinfinitywar1 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpaninfinitywar1.Add(random1);
                }

            }
            Form1.hitinfinitywar1 = 1;
            ...
            for (int i = 0; i < Form1.simpaninfinitywar1.Count; i++)
            {
                foreach (Button a in seat1)
                {
                    if (Form1.simpaninfinitywar1[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpaninfinitywar1.Add(Convert.ToInt32(i));
            }
        ...
        private void btnrst1_Click(object sender, EventArgs e)
        {
            ...
            Form1.simpaninfinitywar1.Clear();
            kar1.Clear();
            karakter1 = "";
        ...
        private void btnjam2_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitinfinitywar2 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpaninfinitywar2.Add(random1);
                }
            }
            Form1.hitinfinitywar2 = 1;
            ...
            for (int i = 0; i < Form1.simpaninfinitywar2.Count; i++)
            {
                foreach (Button a in seat2)
                {
                    if (Form1.simpaninfinitywar2[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke2_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpaninfinitywar2.Add(Convert.ToInt32(i));
            }
        ...
        private void btnrst2_Click(object sender, EventArgs e)
        {
            ...
            Form1.simpaninfinitywar2.Clear();
            kar2.Clear();
            karakter2 = "";
        ...
        private void btnjam3_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitinfinitywar3 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpaninfinitywar3.Add(random1);
                }
            }
            Form1.hitinfinitywar3 = 1;
            ...
            for (int i = 0; i < Form1.simpaninfinitywar3.Count; i++)
            {
                foreach (Button a in seat3)
                {
                    if (Form1.simpaninfinitywar3[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke3_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpaninfinitywar3.Add(Convert.ToInt32(i));
            }
        ...
        private void btnrst3_Click(object sender, EventArgs e)
        {
            ...
            Form1.simpaninfinitywar3.Clear();
            kar3.Clear();
            karakter3 = "";
