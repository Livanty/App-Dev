...
{
    public partial class minions : Form
    {
        public minions()
        {
            InitializeComponent();
        ...
        private void minions_Load(object sender, EventArgs e)
        {
            for (int i = 0; i <= 200; i++)
            {
                angka.Add(i);
            ...
            // Minions
            PictureBox pb_minions = new PictureBox();
            pb_minions.Image = Image.FromFile("C:\\Users\\HP\\source\\repos\\THA_W7_Livanty\\THA_W7_Livanty\\minions.jpeg");
            pb_minions.Location = new Point(20, 10);
            pb_minions.Size = new Size(200, 210);
            pb_minions.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(pb_minions);

            Label lbl_minions = new Label();
            lbl_minions.Text = "MINIONS";
            lbl_minions.Location = new Point(20, 230);
            lbl_minions.Size = new Size(150, 40);
            this.Controls.Add(lbl_minions);
        ...
        private void btnjam1_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitminions1 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    // MessageBox.Show("piu");
                    int random1 = random.Next(0, 170);
                    Form1.simpanminions1.Add(random1);
            ...
            for (int i = 0; i < Form1.simpanminions1.Count; i++)
            {
                foreach (Button a in seat1)
                {
                    if (Form1.simpanminions1[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanminions1.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam2_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitminions2 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanminions2.Add(random1);
                }
            }
            Form1.hitminions2 = 1;
            ...
            for (int i = 0; i < Form1.simpanminions2.Count; i++)
            {
                foreach (Button a in seat2)
                {
                    if (Form1.simpanminions2[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke2_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanminions2.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam3_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitminions3 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanminions3.Add(random1);
                }
            }
            Form1.hitminions3 = 1;
            ...
            for (int i = 0; i < Form1.simpanminions3.Count; i++)
            {
                foreach (Button a in seat3)
                {
                    if (Form1.simpanminions3[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
        ...
        private void btnoke3_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanminions3.Add(Convert.ToInt32(i));
            }
