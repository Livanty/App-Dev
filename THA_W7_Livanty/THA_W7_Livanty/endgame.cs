...
namespace THA_W7_Livanty
{
    public partial class endgame : Form
    {
        ...
        private void endgame_Load(object sender, EventArgs e)
        {
            ...
            // Endgame
            PictureBox pb_endagame = new PictureBox();
            pb_endagame.Image = Image.FromFile("C:\\Users\\HP\\source\\repos\\THA_W7_Livanty\\THA_W7_Livanty\\endgame.jpg");
            pb_endagame.Location = new Point(20, 10);
            pb_endagame.Size = new Size(200, 210);
            pb_endagame.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(pb_endagame);

            Label lbl_endagame = new Label();
            lbl_endagame.Text = "END GAME";
            lbl_endagame.Location = new Point(20, 230);
            lbl_endagame.Size = new Size(150, 40);
            this.Controls.Add(lbl_endagame);
        ...
        private void btnjam1_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitendgame1 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanendgame1.Add(random1);
            ...
            for (int i = 0; i < Form1.simpanendgame1.Count; i++)
            {
                foreach (Button a in seat1)
                {
                    if (Form1.simpanendgame1[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
            ...
            lbl_pilih1.Location = new Point(115, 315);
            lbl_pilih1.Size = new Size(90, 30);
        ...
        private void btnoke1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanendgame1.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam2_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitendgame2 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanendgame2.Add(random1);
                }
            }
            Form1.hitendgame2 = 1;
            ...
            for (int i = 0; i < Form1.simpanendgame2.Count; i++)
            {
                foreach (Button a in seat2)
                {
                    if (Form1.simpanendgame2[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
            ...
            lbl_pilih2.Location = new Point(115, 315);
            lbl_pilih2.Size = new Size(90, 30);
        ...
        private void btnoke2_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanendgame2.Add(Convert.ToInt32(i));
            }
        ...
        private void btnjam3_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.hitendgame3 == 0)
            {
                for (int i = 0; i < 70; i++)
                {
                    int random1 = random.Next(0, 170);
                    Form1.simpanendgame3.Add(random1);
                }
            }
            Form1.hitendgame3 = 1;
            ...
            for (int i = 0; i < Form1.simpanendgame3.Count; i++)
            {
                foreach (Button a in seat3)
                {
                    if (Form1.simpanendgame3[i].ToString() == a.Tag.ToString())
                    {
                        a.Enabled = false;
                    }
                }
            ...
            lbl_pilih3.Location = new Point(115, 315);
            lbl_pilih3.Size = new Size(90, 30);
        ...
        private void btnoke3_Click(object sender, EventArgs e)
        {
            ...
            {
                Form1.simpanendgame3.Add(Convert.ToInt32(i));
            }
